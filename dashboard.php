...
<div class="container h-100 row align-items-center w-100 mx-auto justify-items-center">
    <div class="card w-100 shadow-lg px-5 pb-5">
        <div class="d-flex justify-content-end pt-4">
            <div class="alert alert-warning rounded rounded-circle pt-1 px-2"></div>
            <div class="alert alert-primary  rounded rounded-circle mx-2 pt-1 px-2"></div>
            <div class="alert alert-danger rounded rounded-circle pt-1 px-2"></div>
        </div>
        ...
        <div class="grid">
            <div class="row">
                <div class="col-md-3 display-4 text-center p-0 mb-4">
                    <i class="fa fa-home rounded rounded-circle alert alert-primary p-3"></i>
                    <h5>Home</h5>
                </div>
                <div class="col-md-3 display-4 text-center p-0 mb-4">
